...
public class BottlesOfBeer {
    ...
    public static void main(String[] args) {
        ...
        //start singing from input number of bottles if more than 2 and loop decrementally
        ...
        //grammatically correct verse for 2 bottles if necessary
        if (bottlesInitial >= 2){
        ...
        //gramatically correct verse for 1 bottle if necessary
        if (bottlesInitial >= 1){
        ...
        //gramatically correct finish of song
